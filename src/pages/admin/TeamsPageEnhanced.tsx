...
const TeamsPage: React.FC = () => {
	...
	}, [page, debouncedQuery, locationFilter, ordering]);
		...
		<DashboardLayout>
			...
			<div className="mb-6">
				<div className="flex items-center justify-between">
					<div>
						<h1 className="text-[28px] font-bold text-gray-900">Teams</h1>
						<p className="text-sm text-gray-600 mt-1">Manage all teams and rosters</p>
					</div>
					<button
			...
			<div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
				{loading && teams.length === 0 ? (
					...
					<div className="p-12 text-center">
						...
						<p className="text-gray-600 mb-6">Add your first team</p>
						<button
							onClick={openCreateModal}
									...
									<tr>
										...
										>
											<div className="flex items-center gap-2">
												<span className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Team Name</span>
												{sortField === 'name' && (
